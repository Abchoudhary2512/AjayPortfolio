  ...
  return (
    <div className='landingPageContain'>
      ...
      <div className='socialMedia'>
        ...
        <div><a href='https://github.com/Abchoudhary2512'><FaGithub className='xyz' style={{ color: "white" }} size={25} /></a></div>
        <div><a href='https://www.linkedin.com/in/ajaybhakar/'><FaLinkedin className='xyz' style={{ color: "white" }} size={25} /></a></div>
        <div><a href='https://x.com/ajay_2512x'><RiTwitterXFill className='xyz' style={{ color: "white" }} size={25} /></a></div>
        <div><a href='mailto:bhakarajay033@gmail.com'><BiLogoGmail className='xyz' style={{ color: "white" }} size={25} /></a></div>
      </div>
      <Navbar />
