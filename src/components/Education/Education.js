      ...
      <div className="eduCard">
        <div className="lineIconEdu">
          <div className="eduIcon">
            <IoSchoolOutline style={{ color: "rgb(255, 120, 36)" }} size={70} />
          </div>
          <div className="eduLine"></div>
        </div>
        <div className="eduContent">
          <div className="durationEdu">2021 - Present</div>
          <div className="headingEdu">
            BACHELOR DEGREE -{" "}
          ...
          <div className="detailEdu">
            ...
            where I have gained a robust understanding of core computer science
            concepts like algorithms, data structures, Objected Oriented
      ...
      <div className="eduCard">
        ...
        <div className="eduContent">
          ...
          <div className="headingEdu">
            SECONDARY EDUCATION -{" "}
            <span className="instituteName">
              Tagore International School Kuchaman City
            </span>
          </div>
          <div className="detailEdu">
            During my high school education, I developed a strong interest in
            subjects such as Math, Physics and Chemistry. I also enjoyed
